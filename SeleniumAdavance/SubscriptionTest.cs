...

{
    public class SubscriptionTest
    {
        ...
        public void AddSubscriptionTest()
        {
            ...
            driver.FindElement(By.XPath("//input[@name='demo59703']")).SendKeys("Gaurav");
            driver.FindElement(By.XPath("//input[@id='id2']")).SendKeys("Kshirsagar");
            ...
            driver.FindElement(By.XPath("//input[@id='id11']")).SendKeys("8");
            ...
            driver.FindElement(By.XPath("//input[@id='id11']")).SendKeys("9503693729");
